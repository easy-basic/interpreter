...
// term.fit();
term.write(' Black  Blue Bright Blue ')
term.write(' BrightCyan  brightGreen  brightMagenta ')
term.write(' brightRed  brightWhite  brightYellow ')
term.write(' green  magenta  red ')
term.write(' white  yellow')
...
require(['vs/editor/editor.main'], function () {
    monaco.languages.register({
        id: 'easybasic',
        extensions: ['.eb'],
        aliases: ['EasyBasic', 'eb'],
        loader: () => _monaco.Promise.wrap({
            conf: {
                comments: {
                    lineComment: '\'',
                    blockComment: ['/*', '*/'],
    ...
    monaco.languages.setMonarchTokensProvider('easybasic',
        {
            defaultToken: '',
            tokenPostfix: '.eb',
            ignoreCase: true,
    ...
    monaco.languages.setLanguageConfiguration('easybasic',
        {
            comments: {
                lineComment: '\'',
                blockComment: ['/*', '*/'],
